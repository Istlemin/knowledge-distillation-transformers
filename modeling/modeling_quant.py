...
from .utils_quant import QuantizeLinear, QuantizeEmbedding, SymQuantizer, AsymQuantizer
...
class BertSelfAttention(nn.Module):
    def __init__(self, config):
        ...
        if self.quantize_act:
            ...
            self.act_quantizaer = AsymQuantizer
    ...
    def forward(self, hidden_states, attention_mask, head_mask=None,
            ...
            past_key_value=None,output_att=False):
...
class BertModel(BertPreTrainedModel):
    ...
    def forward(self, input_ids, token_type_ids=None, attention_mask=None):
        ...
        extended_attention_mask = extended_attention_mask.to(
            dtype=self.embeddings.position_embeddings.weight.dtype)  # fp16 compatibility
        extended_attention_mask = (1.0 - extended_attention_mask) * torch.finfo(self.embeddings.position_embeddings.weight.dtype).min
